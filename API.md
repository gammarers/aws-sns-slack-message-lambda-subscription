...
| <code><a href="#@gammarers/aws-sns-slack-message-lambda-subscription.SNSSlackMessageLambdaSubscription.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@gammarers/aws-sns-slack-message-lambda-subscription.SNSSlackMessageLambdaSubscription.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@gammarers/aws-sns-slack-message-lambda-subscription.SNSSlackMessageLambdaSubscription.with.parameter.mixins"></a>
